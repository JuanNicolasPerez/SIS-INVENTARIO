...
class ModeloVentas{
    ...
    static public function mdlMostrarVentas($tabla, $item, $valor){
        ...
        if ($item != null) {
            ...
            $stmt = (new Conexion) -> conectar() -> prepare("SELECT * FROM $tabla WHERE $item = :$item ORDER BY id ASC");
            ...
            $stmt = (new Conexion) -> conectar() -> prepare("SELECT * FROM $tabla ORDER BY id ASC");
	...
	static public function mdlRangoFechasVentas($tabla, $fechaInicial, $fechaFinal){
		...
		if($fechaInicial == null){
			...
			$stmt = (new Conexion)-> conectar()->prepare("SELECT * FROM $tabla WHERE fecha LIKE '%$fechaFinal%'");
