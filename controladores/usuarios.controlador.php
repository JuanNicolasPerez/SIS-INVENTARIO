...
class ControladorUsuarios{
        ...
        if (isset($_POST["nuevoUsuario"])) {
            ...
            if (preg_match('/^[-a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/',$_POST["nuevoNombre"]) &&
                ...
                if (isset($_FILES["nuevaFoto"]["tmp_name"])) {
                    ...
                    /*--==============================
                    CREAMOS EL DIRECTORIO DONDE VAMVOS A GUARDAR  LA FOTO DEL USUARIO
                    ===============================-*/
                    $directorio = "vistas/img/usuarios/".$_POST["nuevoUsuario"];
                    mkdir($directorio, 0755);

                    /*--==============================
                    DEACUERDO AL TIPO DE IMAGEN APLICAMOS LAS FUNSIONES DE PHP
                    ===============================-*/
    ...
    static public function ctrMostrarUsuarios($item, $valor){
        ...
        $respuesta = (new ModeloUsuarios) -> mdlMostrarUsuarios($tabla, $item, $valor);
        ...
        if (isset($_POST["editarUsuario"])) {
            ...
            if (preg_match('/^[-a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/',$_POST["editarNombre"])){
                ...
                if (isset($_FILES["editarFoto"]["tmp_name"]) && !empty($_FILES["editarFoto"]["tmp_name"])) {
                    ...
                    /*--==============================
                    PRIMERO PREGUNTAMOS SI EXITE OTRA FOTO EN LA BD
                    ===============================-*/
                    ...
                    if(preg_match('/^[-a-zA-Z0-9]+$/',$_POST["editarPassword"])){
                        ...
                        echo '
                            <script>
                                swal({
                                    type:"error",
                                    title:"!El contraseña no puede ir vacia o llevar caracteres especiales¡",
                                    showConfirmButton:true,
                                    confirmButtonText:"Cerrar.",
                                    closeOnConfirm:false
                                }).then((result)=>{
    ...
    static public function ctrBorrarUsuario(){
        if(isset($_GET["idUsuario"])){
            ...
            $respuesta = (new ModeloUsuarios) -> mdlBorrarUsuario($tabla, $datos);
